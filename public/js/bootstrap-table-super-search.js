!function($) {
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        html.push('<ul class="dropdown-menu" id="superSearchMenu" role="menu" style="min-width: 300px">');
        ...
        $.each(superSearchItems,function(index,value){
            if(value.type==='text') {
                $superSearchFormGroup.append('<label for="' + value.field + '" class="col-md-4 col-sm-4 col-xs-4 control-label" style="padding-top:5px;">' + value.label + '</label><div class="col-md-8 col-sm-8 col-xs-8 forminput-padding"><input type="text" id="' + value.field + '" class="form-control" name="' + value.field + '" placeholder="' + value.placeholder + '"/></div>');
            }else if(value.type==='date'){
                $superSearchFormGroup.append('<label for="' + value.field+'" class="col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top: 5px;">'+value.label+'</label><div class="col-md-8 col-sm-8 col-xs-8 forminput-padding"><input class="form-control" type="text" id="'+value.field+'" name="'+value.field+'" placeholder="'+value.placeholder+'" readonly/></div>');
            }else if(value.type==='dateRange'){
                $superSearchFormGroup.append('<label for="' + value.field+'" class="col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top: 5px;">'+ value.label +'</label><div class="col-md-8 col-sm-8 col-xs-8 forminput-padding"><input class="form-control" type="text" id="'+value.field+'" name="'+value.field+'" placeholder="'+value.placeholder+'" readonly/></div>');
            }else if(value.type==='select'){
                $superSearchFormGroup.append('<label for="' + value.field+'" class="col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top: 5px;">'+ value.label +'</label><div class="col-md-8 col-sm-8 col-xs-8 forminput-padding"><select id="'+value.field+'"></select></div>');
                ...
                $superSearchFormGroup.append('<label for="' + value.field+'" class="col-md-4 col-sm-4 col-xs-4 control-label" style="margin-top: 5px;">'+ value.label +'</label><div class="col-md-8 col-sm-8 col-xs-8 forminput-padding"><select class="form-control form-select" id="'+value.field+'" name="'+value.field+'">'+_keyDataOption+'</select></div>');
            }
        });
        $superSearchFormGroup.append('<br><br><div class="col-md-12 col-sm-12 col-xs-12"><div class="btn-group  pull-left">' +
        ...
        if(this.options.showSuperInput){
            html.push(
                ...
                sprintf('<div class="input-group" style="width:300px;margin-top: 10px">' +
                    ...
                    '<button class="btn btn-default" type="button" name="_simpleSearchText"><i class="glyphicon glyphicon-search"></i></button>' +
                    '</span>' +
